  ...
  phases: [
    {
      sources: [
        ...
        { name: 'schemas', path: '**/schemas/*.js', merge: true },
    ...
    {
      sources: [
        { name: 'controllers', path: '**/controllers/api/*.restifizer.controller.js' },
        { name: 'fileControllers', path: '**/controllers/file/*.restifizer.controller.js' },
      ],
      makers: [
        '../makers/express.js',
        '**/services/*.service.js',
